...
**Wednesday 2026-05-27 is the real go-live.** the first host (`host@example.com`) opens it that night to host actual trivia at her venue. NOT a demo — paying patrons. ~3 days from this handoff (Sun 2026-05-24 ~3pm).
...
Brandon does the same 2-phone test he did today. Confirm both fixes. If green, merge. the first host goes live in 2 days from then.
...
- `feedback_first_host_real_customer.md` — Wednesday is a real go-live.
