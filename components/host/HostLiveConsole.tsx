...
// the venue screen, so whatever the first host sees, the patrons see. That means
...
export interface HostLiveConsoleProps {
  ...
  onAddPlayer?: () => void;
  /** Promote game 1 from draft/ready to live so the first host can start playing.
   ...
   *  fullscreen — the first host's laptop drives both surfaces in one window. */
