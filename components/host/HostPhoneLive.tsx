    ...
    <PhoneScreen weather={false} style={{ color: t.ink, gap: 16 }}>
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
        <div style={{ minWidth: 0 }}>
          <Eyebrow color={t.ink} size={10}>QUESTION LIVE</Eyebrow>
          <p style={{ margin: "6px 0 0", color: t.ink, fontSize: 11, fontWeight: 800, letterSpacing: ".08em", textTransform: "uppercase" }}>
      ...
      <section aria-label="Confirmed answers" style={panel}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 12, flexWrap: "wrap" }}>
          ...
          <span style={{ color: t.ink, fontFamily: "var(--font-mono)", fontSize: 12, fontWeight: 800 }}>{waiting} waiting</span>
        </div>
        ...
        <p style={{ margin: "10px 0 0", color: t.ink, fontSize: 12, lineHeight: 1.4 }}>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center" }}>
          <Eyebrow color={t.ink} size={9}>EXPECTED VENUE TV</Eyebrow>
          <span style={{ color: t.ink, fontSize: 11, fontWeight: 750 }}>Venue TV not confirmed</span>
        </div>
        <div style={{ marginTop: 10, aspectRatio: "16 / 7", border: `1px solid ${t.line}`, borderRadius: 12, background: t.paper, display: "grid", placeItems: "center", padding: 12, textAlign: "center", boxSizing: "border-box" }}>
          <div>
            <p style={{ margin: 0, color: t.ink, fontSize: 9, fontWeight: 900, letterSpacing: ".12em", textTransform: "uppercase" }}>{categoryName} · {pointValue} pts</p>
