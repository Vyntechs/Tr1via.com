...
const KEEPSAKES: Keepsake[] = [
  ...
  { id: "pom-1",  kind: "pom",  left: 22, staticTop: 8,  size: 25, duration: 38, delay: 16, drift: 46,  opacity: 0.48, rotate: -15, tone: "cool" },
  ...
  { id: "pom-2",  kind: "pom",  left: 64, staticTop: 88, size: 27, duration: 41, delay: 8,  drift: -36, opacity: 0.44, rotate: 22,  tone: "clay" },
  ...
  { id: "pom-3",  kind: "pom",  left: 95, staticTop: 58, size: 23, duration: 39, delay: 33, drift: 27,  opacity: 0.45, rotate: -29, tone: "cool" },
...
export function SeptemberHomecomingDrift({
  ...
  const visible = KEEPSAKES.filter((keepsake, index) => {
    ...
    if (compact) return [0, 2, 6, 9, 10, 13].includes(index);
    return true;
  });
