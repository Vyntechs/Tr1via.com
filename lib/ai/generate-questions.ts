...
//
// Model: claude-sonnet-4-6. Timeout: 30 seconds.
...
/**
 * Default Sonnet model id. Exposed for the test that asserts we send the
 * configured model. The plan calls for `claude-sonnet-4-6`.
 */
