  ...
  return (
    <main className="mx-auto max-w-[760px] px-6 py-16 text-ink sm:px-8">
      ...
      <Section title="Cookies and your device">
        <P>
          TR1VIA uses a small number of first-party cookies. We do not use any
          advertising or third-party tracking cookies, and we do not keep a
          browser-readable copy of the player device identifier.
        </P>
        <Table
          ...
          rows={[
            [
              "tr1via_device",
              "TR1VIA",
              "A signed HTTP-only cookie holding a random device identifier. It lets us recognize your device so we can keep your score during a game and recognize you if you rejoin. Because it is HTTP-only, browser JavaScript cannot read it. It is a persistent identifier and is stored with your player record.",
              "Up to 1 year",
            ],
            [
              "sb-…-auth-token",
