...
- Production check on Chromecast / actual TV before the first host's go-live.
...
- the first host goes live today (2026-05-27). May ends in 4 days. After June 1, calendar moves to whatever the June theme is (no ceremony). If the first host pins May, ceremony persists.
