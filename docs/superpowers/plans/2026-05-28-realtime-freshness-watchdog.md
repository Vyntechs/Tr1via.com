...
**Goal:** Auto-recover the host's silently-dead realtime connection (the zombie WebSocket after laptop sleep that froze Heather's show for 215s) by watching data freshness + a wake-from-sleep gap and forcing a brand-new socket — host only.
